      ...
      <form className="donor-form__form" onSubmit={handleSubmit}>
        <div className="donor-form__grid">
          ...
          <div className="donor-form__field">
            ...
            {(dateErrors.dob || fieldErrors.dob) && <span className="donor-form__field-error">{dateErrors.dob || fieldErrors.dob}</span>}
          </div>
          ...
          <div className="donor-form__field">
            ...
            {(dateErrors.lastDonation || fieldErrors.lastDonation) && <span className="donor-form__field-error">{dateErrors.lastDonation || fieldErrors.lastDonation}</span>}
          </div>
